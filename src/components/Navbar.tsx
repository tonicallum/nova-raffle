        ...
        <ul className="flex items-center gap-[16px]">
          <li>
            ...
            >
              ...
              >
                <path
                  d="M4.14587 14.625H1.37504C0.939624 14.625 0.583374 14.2688 0.583374 13.8333V5.91667C0.583374 5.48125 0.939624 5.125 1.37504 5.125H4.14587C4.58129 5.125 4.93754 5.48125 4.93754 5.91667V13.8333C4.93754 14.2688 4.58129 14.625 4.14587 14.625ZM9.88546 0.375H7.11462C6.67921 0.375 6.32296 0.73125 6.32296 1.16667V13.8333C6.32296 14.2688 6.67921 14.625 7.11462 14.625H9.88546C10.3209 14.625 10.6771 14.2688 10.6771 13.8333V1.16667C10.6771 0.73125 10.3209 0.375 9.88546 0.375ZM15.625 6.70833H12.8542C12.4188 6.70833 12.0625 7.06458 12.0625 7.5V13.8333C12.0625 14.2688 12.4188 14.625 12.8542 14.625H15.625C16.0605 14.625 16.4167 14.2688 16.4167 13.8333V7.5C16.4167 7.06458 16.0605 6.70833 15.625 6.70833Z"
                  className="svgImg"
                />
              </svg>
          ...
          {storeData.wallet === "connected" && (
            <li>
              <Link to="/profile/raffle">
                ...
                >
                  <path
                    d="M23.046 4.45408C20.4961 1.90426 17.106 0.5 13.5 0.5C9.89402 0.5 6.50389 1.90426 3.95402 4.45408C1.40426 7.00389 0 10.394 0 14C0 17.606 1.40426 20.9961 3.95402 23.5459C6.50389 26.0957 9.89402 27.5 13.5 27.5C17.106 27.5 20.4961 26.0957 23.046 23.5459C25.5957 20.9961 27 17.606 27 14C27 10.394 25.5957 7.00389 23.046 4.45408ZM13.5 25.918C9.97371 25.918 6.80078 24.378 4.61679 21.9359C5.97074 18.3465 9.43671 15.793 13.5 15.793C10.8788 15.793 8.75391 13.6681 8.75391 11.0469C8.75391 8.42566 10.8788 6.30078 13.5 6.30078C16.1212 6.30078 18.2461 8.42566 18.2461 11.0469C18.2461 13.6681 16.1212 15.793 13.5 15.793C17.5633 15.793 21.0293 18.3465 22.3832 21.9359C20.1992 24.378 17.0263 25.918 13.5 25.918Z"
                    fill="white"
                  />
                </svg>
              </Link>
