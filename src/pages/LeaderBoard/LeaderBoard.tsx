...
const LeaderBoard = () => {
  ...
  const fetchRafflers = async (tempAllRaffle: any) => {
    ...
    tempRafflerSort = tempRafflerSort.map((item: any, index: number) => ({
      ...item,
      discord: userInfos[index]?.discordName,
      twitter: userInfos[index]?.twitterName,
    }));
  ...
  const fetchBuyRaffler = async (tempAllRaffle: any) => {
    ...
    const userInfos: any[] = await Promise.all(
      tempFoundBuyGroupBySort.map((item: any) => getUser(item?.buyer))
    );
        ...
        <div className="md:max-w-[100%] lg:w-full  mx-[auto] my-0 ">
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-center mr-1 ml-1 mb-1 ">
            <div className=" basis-[48%] ">
              ...
              <div className="border-[#5a2fbe] border-solid border-[1px] text-black rounded-2xl p-3 nftItem-shadow mt-4 leaderboard-container min-w-[350px]">
        ...
        >
          ...
          <div className="w-[25%] text-center">
            ...
            <div className="basis-[48%]">
              ...
              <div className="overflow-x-auto"> 
              <div className="bg-white border-[#5a2fbe] border-solid border-[1px] text-black rounded-2xl p-3 nftItem-shadow mt-4 min-w-[350px] ">
              <div className="table-container "> 
