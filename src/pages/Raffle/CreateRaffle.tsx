    ...
    try {
      ...
      if (createRaffleTx) {
        const payload: any = {
          ...
          tokenAddress: raffleValue.tokenAddress.toString().toLowerCase(),
        ...
        <div className="max-w-[768px] m-auto pt-20 pb-16 px-4 md:px-0">
          ...
          {storeData.wallet !== "connected" ? (
            <div className="mt-6 md:px-8 px-[30px] py-[40px]  rounded-[0.7rem] nftItem-shadow bg-white border-[none]">
              ...
              <p className="text-[#666] text-[24px] ">
            ...
            <div className=" mt-6 md:px-8 px-4 pt-8 pb-8  rounded-[0.7rem] nftItem-shadow bg-white border-[none]">
              <div className="md:flex block justify-between items-start">
                <div className="min-h-[295px] basis-[46%]">
                  ...
                  >
                    ...
                    <span className="text-[white] text-md mt-2">
                      {" "}
                      {contractType}
                    </span>
                  </div>
                  ...
                  {contractType === "ERC1155" && (
                    <div className="nft-count border-[black] border-[1px] border-solid ">
                      <div
                        className="nft-decrease text-black "
                        onClick={handleNftDecrease}
                      >
                        -
                      </div>
                      <div className="nft-amount text-black ">{nftAmount}</div>
                      <div
                        className="nft-increase text-black "
                        onClick={handleNftIncrease}
                      >
                        +
                      </div>
                    </div>
                    ...
                    <div className="relative border-2 border-[#606060] rounded-[0.5rem] overflow-hidden">
                      <input
                        ...
                        onChange={(e: any) => {
                          setTotlaTicketValue(
                            raffleValue.price
                              ? e.target.value * raffleValue.total_tickets
                              : 0
                          );
                          setRaffleValue({
                            ...raffleValue,
                    ...
                    <div className="relative border-2 border-[#606060] rounded-[0.5rem] overflow-hidden">
                      <input
                        ...
                        onChange={(e: any) => {
                          setTotlaTicketValue(
                            raffleValue.price
                              ? e.target.value * raffleValue.price
                              : 0
                          );
                          setRaffleValue({
                            ...raffleValue,
              ...
              <p className="text-[14px] text-[red] text-center">
                Please link your twitter and discord in{" "}
                <span className="underline">
                  <Link to="/profile/raffle">your profile</Link>
                </span>{" "}
                or your raffles won't be shown
              </p>
